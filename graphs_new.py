...
CONFIG_RESULTS = {
    "nano, 1int8, titanV, 640x360": (355, 0.71, 0.55, 91.63, 0.84),
    "nano, 2fp16, titanV, 640x360": (267, 0.80, 0.64, 92.41, 0.93),
    "nano, 3fp32, titanV, 640x360": (221, 0.80, 0.64, 92.42, 0.93),
...
def plot_results(fixed, shapes, colors, hw):
    ...
    for fixed_val in fixed_values:
        ...
        plt.ylabel(r"$\rightarrow$ Recall $\rightarrow$", fontsize=26)
